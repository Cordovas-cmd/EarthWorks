      ...
      <div className="container">
        <div className="row">
                ...
                <div className="col-lg-12">
                  <div className="d-flex-all justify-content-between">
                    <div className="header-logo">
                      <Link href="/">
                        <figure>
                          <img className="brand-logo"src={appData.header.logo.image} alt={appData.header.logo.alt} />
                        </figure>
                      </Link>
                    </div>
                    <div className="nav-bar">
                      ...
                      <div className="extras">
                        ...
                        {contactButton != 1 &&
                        <a href="tel:+4402275799" className="theme-btn">
                          1+(440)227-5799
                          <i>
          ...
          <div className="mobile-nav desktop-menu">
            <h2>There to meet your needs.</h2>
            <p className="des">We successfully cope with tasks of varying complexity, provide long-term guarantees and ensure peace of mind and quality.</p>
            ...
            <h3>Get in touch</h3>
            <p className="num">(440)227-5799</p>
            <p className="adrs">
Serving the Greater Cleveland Area</p>
