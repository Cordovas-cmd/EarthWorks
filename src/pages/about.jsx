    ...
    <Layouts>
      ...
      <section className="gap about-first">
        <div className="container">
          <div className="row">
            <h2>Locally Owned excavation and construction company specializing in Excavation and specialty services</h2>
          </div>
        </div>
        <div className="container">
          <div className="row">
            <div className="col-lg-6">
              <div className="who-we-are">
                <div>
                  ...
                  <p>Ivy Earthworks is locally owned by a  skilled tradesman who started out helping his neighbors before demand spread to the greater Cleveland area. Whether you are looking for excavation, renovation, trenching, drainage, grading, or even dumpsters, we are here to work  for you.  </p>
                </div>
                <figure>
            ...
            <div className="col-lg-5 offset-lg-1">
              <div className="who-we-are space">
                <div>
                  ...
                  <ul>
                    <li><i className="fa-solid fa-circle-dot" /> High performing, methodical work.</li>
